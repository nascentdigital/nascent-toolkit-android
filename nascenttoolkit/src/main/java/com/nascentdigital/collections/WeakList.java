package com.nascentdigital.collections;
...
/**
 * A collection that contains weak references to all objects in it. Prevents memory leaks.
...
public final class WeakList<T> implements Collection<T>
{
	...
	public boolean add(T object)
	{
		...
		// add item
		return _list.add(new WeakReference<>(object));
	}
	...
	public boolean addAll(Collection<? extends T> objects)
	{
		...
		{
			_list.add(objectIndex++, new WeakReference<>(object));
		}
	...
	public boolean contains(Object object)
	{
		...
		for (WeakReference<T> objectReference : _list) {
			if (objectReference != null && objectReference.get() == object) {
				return true;
			}
		}
	...
	public Iterator<T> iterator()
	{
		...
		// copy/prune list
		final List<T> objects = new ArrayList<>(referenceCount);
		final List<WeakReference<T>> removedReferences =
				new ArrayList<>(referenceCount);
