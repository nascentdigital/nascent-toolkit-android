...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    private static boolean isIPAddress(final String hostname) {
        //final boolean ipv4 = InetAddressUtils.isIPv4Address(mAllowedHost);
        //final boolean ipv6 = InetAddressUtils.isIPv6Address(mAllowedHost);
    ...
    private String normaliseIPv6Address(final String hostname) {
        if (hostname == null || !isValidIp6Address(hostname)) {
            return hostname;
        }
        try {
